...
from torchanipbe0.units import hartree2kcalmol
...
class Constants(collections.abc.Mapping):
    ...
    def __init__(self, filename):
        ...
        # print('path', os.path.abspath(self.filename))
        ...
        # print('species_to_tensor: ', self.species_to_tensor)
...
# Create the different model loader to load with desired architecture
# Author: Christopher N. Rowley - Tu Nguyen Thien Phuc
# Last update: 2021-09-30

def load_model_2(dir_, aev_dim):
...
def load_model_ensemble_2(prefix, count, aev_dim):
    models = []
    for i in range(count):
...
__all__ = ['Constants', 'load_sae', 'load_model', 'load_model_ensemble',
           'load_model_2', 'load_model_ensemble_2', 'Trainer', 'parse_neurochem_resources']
