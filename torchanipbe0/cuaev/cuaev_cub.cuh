...
// Modern CUB (bundled with CUDA 12+, part of CCCL) versions itself via an
// internal inline namespace, so the CUB_NS_PREFIX/POSTFIX wrapping trick from
// https://github.com/pytorch/pytorch/pull/55292 (needed for old CUB <2.0) is
// both unnecessary and incompatible with it (internal cub:: cross-references
// don't get rewritten by those macros in CUB 2.x). Just include it directly.
#include <cub/cub.cuh>
